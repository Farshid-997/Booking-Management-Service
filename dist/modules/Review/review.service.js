...
const createReview = (review) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result) {
        throw new ApiError_1.default(400, 'failed to created new review');
    }
    return result;
});
const getAllReview = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const total = yield prisma.review.count({
        where: whereConditions,
    });
