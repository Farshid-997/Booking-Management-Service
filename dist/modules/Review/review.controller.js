...
const getAllReviews = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield review_service_1.reviewService.getAllReview(filters, options);
    (0, sendResponse_1.sendResponse)(res, {
...
const singleReview = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
